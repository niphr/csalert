...
observations of a `surveillance` `sts` object. It sets the alarm slot to
1 for time points with a significant increasing trend, and to 0
otherwise. The method is based upon a published analytics strategy by
Benedetti (2019) \<doi:10.5588/pha.19.0002\>. This function was frozen
on 2024-06-24 and operates on `sts` objects.
